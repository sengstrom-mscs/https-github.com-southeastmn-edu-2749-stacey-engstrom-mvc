...
namespace ex1b.Migrations
{
    ...
    [Migration("20220122213548_Inheritance")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ex1b.Models.Person", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ex1b.Models.Instructor", b =>
                {
                    b.HasBaseType("ex1b.Models.Person");
            ...
            modelBuilder.Entity("ex1b.Models.Instructor", b =>
                {
                    b.HasOne("ex1b.Models.Person", null)
                        .WithOne()
                        .HasForeignKey("ex1b.Models.Instructor", "ID")
            ...
            modelBuilder.Entity("ex1b.Models.Student", b =>
                {
                    b.HasOne("ex1b.Models.Person", null)
                        .WithOne()
                        .HasForeignKey("ex1b.Models.Student", "ID")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
